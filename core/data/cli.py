...
def load_command() -> None:
    ...
    parser.add_argument(
        "--session", type=str, required=True, help="Session type: R, Q, FP1, FP2, FP3"
    )
    parser.add_argument(
        "--driver", type=str, default=None, help="Optional driver code e.g. VER"
    )

    args = parser.parse_args()

    logger.info("PitWall AI — Loading data...")
